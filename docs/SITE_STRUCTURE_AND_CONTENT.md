...
## 12. サイトの拡張（2026年3月時点のメモ）

- **記事**  
  固定費・家計・返済比較に加え、体験記・副業・節約のカテゴリを設け、カテゴリ別の一覧から読めるようにしています。

- **ツール**  
  借入返済の試算に加え、固定費を減らしたときの長期的な効果を試算するツールを用意しています。

- **読みやすさ**  
  各記事に前提条件・読み方の注意・関連リンクを置き、迷わず読み進められるよう工夫しています。

---

## 主要なページ（2026年3月）

- **サイト名**　「借金と暮らしの記録」。返済・固定費の試算は「借入返済シミュレーター」などのツールで行えます。
- **体験記・副業・節約**　カテゴリごとの記事一覧から、テーマに沿って読めます。
- **相談先ガイド・用語集・記事検索**　公的な相談窓口の案内、用語の説明、キーワードでの記事探しができます。
- **更新のお知らせ**　サイトの更新内容を一覧できます。
- **体験談の送信**　匿名での体験共有用のフォームを用意しています（掲載は運営の判断によります）。
