        ...
        <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-soft md:p-8">
          ...
          <div className="mt-8 space-y-10 text-sm text-gray-700 leading-relaxed">
            ...
            <section id="conclusion">
              <h2 className="text-lg font-black text-gray-900 md:text-xl">結論｜リボ払い100万円の利息はかなり大きくなりやすい</h2>
              <p className="mt-3">
            ...
            <section id="reason">
              <h2 className="text-lg font-black text-gray-900 md:text-xl">リボ払いで利息が増えやすい理由</h2>
              <p className="mt-3">
            ...
            <section id="30k">
              <h2 className="text-lg font-black text-gray-900 md:text-xl">毎月3万円で返す場合</h2>
              <p className="mt-3">
            ...
            <section id="50k">
              <h2 className="text-lg font-black text-gray-900 md:text-xl">毎月5万円で返す場合</h2>
              <p className="mt-3">
            ...
            <section id="compare">
              <h2 className="text-lg font-black text-gray-900 md:text-xl">毎月3万円と5万円の比較</h2>
              <p className="mt-3">
                ...
                <table className="w-full min-w-[320px] border-collapse text-left">
                  <thead>
                    <tr className="border-b-2 border-gray-200">
                      ...
                      <th className="py-3 pr-4 font-black text-gray-900">完済までの期間</th>
            ...
            <section id="danger">
              <h2 className="text-lg font-black text-gray-900 md:text-xl">リボ払い100万円は危険なのか</h2>
              <p className="mt-3">
            ...
            <section id="reduce-interest">
              ...
              <div className="mt-4 space-y-4">
                <div>
                  <h3 className="text-base font-black text-gray-900">毎月の返済額を増やす</h3>
                  <p className="mt-1">返済額を増やすと元本の減りが早くなり、その後の利息も減りやすくなります。</p>
                </div>
                <div>
                  <h3 className="text-base font-black text-gray-900">追加返済を活用する</h3>
                  <p className="mt-1">臨時収入やボーナスがある月に追加返済できれば、完済までの期間短縮に役立ちます。</p>
                </div>
                <div>
                  <h3 className="text-base font-black text-gray-900">金利や返済条件を見直す</h3>
            ...
            <section id="faq">
              ...
              <div className="mt-4 space-y-6">
                <div>
                  <h3 className="text-base font-black text-gray-900">リボ払い100万円の利息はいくらですか？</h3>
                  <p className="mt-2">
                    年利15%を目安にすると、毎月3万円返済では総利息約47.5万円、毎月5万円返済では約18.5万円が目安です。返済額が低いほど利息は増えやすくなります。
                  </p>
                </div>
