          ...
          <div className="mt-8 space-y-10 text-sm text-gray-700 leading-relaxed">
            ...
            <section id="comparison-table">
              ...
              <div className="mt-6 ds-subcard p-4">
                <h3 className="text-sm font-black text-gray-900">累計改善額のイメージ（月5,000円×継続月数）</h3>
            ...
            <section id="where-to-cut">
              ...
              <p className="mt-3">
                ...
                で順番に整理できます。
                <Link href="/articles/fixed-cost-guide" className="font-bold text-gray-900 hover:underline ml-1">固定費見直しの進め方</Link>
                もあわせて参照してください。
              </p>
            </section>
            ...
            <section id="faq">
              ...
              <dl className="mt-4 space-y-4">
                <div>
                  <dt className="font-bold text-gray-900">月5,000円の固定費見直しは意味がありますか？</dt>
                  <dd className="mt-1 text-gray-700">
                    はい。月額では小さく見えても、1年で6万円、3年で18万円、5年で30万円と、継続すると無視できない差になります。固定費改善は一度見直すと毎月効果が続くため、続けるほど累計は大きくなります。
                  </dd>
                </div>
                <div>
                  <dt className="font-bold text-gray-900">固定費はどこから見直すと5,000円削減しやすいですか？</dt>
                  <dd className="mt-1 text-gray-700">
            ...
            <section id="summary">
              ...
              <ul className="mt-3 list-disc pl-5 space-y-1">
                ...
                <li>自分の改善額の累計は
                  <Link href="/tools/fixed-cost-impact" className="font-bold text-gray-900 hover:underline">固定費削減インパクト計算ツール</Link>
                  で確認できます。
                </li>
                <li>
                  <Link href="/articles/fixed-cost-checklist" className="font-bold text-gray-900 hover:underline">固定費見直しチェックリスト</Link>
                  ...
                  もあわせてご覧ください。
                  <Link href="/articles" className="font-bold text-gray-900 hover:underline ml-1">記事一覧</Link>
                  から他のカテゴリも探せます。
                </li>
              </ul>
            </section>
