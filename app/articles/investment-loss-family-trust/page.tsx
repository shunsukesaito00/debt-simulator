...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: ARTICLE_TITLE,
    description:
      "損失を取り返そうとする焦りは取引の種類を変えても消えず、口座と生活は別カレンダーで進む。家族に助けを求めた転機と、いま取り返している信用の話です。",
    url: ARTICLE_URL,
    type: "article",
  },
};
          ...
          <ArticleProse className="mt-8 space-y-10">
            <section id="intro" className="space-y-4">
              ...
              <p>
                ...
                せめて元に戻したい。
                <br />
                その気持ちで、現物株から信用取引に進み、さらにFXや高いレバレッジの取引へと進みました。
              </p>
              <p>
                でも、最後に失ったと強く感じたのは、お金そのものだけではありませんでした。
                妻や両親に助けを求めることになったとき、取り返したいものは口座残高ではなく、家族からの信用だったのだとようやく分かりました。
              </p>
              <p>
                これは、投資で成功した話ではありません。
                止まれなくなったときに、何が少しずつ壊れていったのか。その記録です。
              </p>
            </section>
            ...
            <section id="message" className="space-y-4">
              ...
              <ul className="list-disc pl-5 space-y-2 text-stone-800">
                ...
                <li>口座の数字と、生活の支払いの締切は別々に進むこと</li>
                <li>最後に失うとつらいのは、お金だけでなく家族との信用でもあること</li>
              </ul>
              <p>
                投資や借入を勧めたいわけではありません。
                同じように、金欠や返済、見えない不安で苦しくなっている人に、こういう崩れ方もあると伝えたくて書いています。
              </p>
            </section>
            ...
            <section id="start">
              ...
              <p className="mt-3">
                ...
                少しでも今より生活が良くなればいい、その程度の気持ちでした。
              </p>
              <p className="mt-3">
                最初は現物株から入りました。
                SNSで話題になっている銘柄を見て、自分でも売買するようになりました。今振り返ると、話題に乗るだけの後追いになっていた場面も多かったと思います。
              </p>
            ...
            <section id="stocks">
              ...
              <p className="mt-3">
                手元の資金は、おおよそ100万円くらいから始まり、半分近くまで減りました。
                そのあたりから、気持ちが変わりました。
              </p>
              <p className="mt-3">
                それまでは「少し増えたらいい」と思っていたのに、いつの間にか「減った分を戻さないといけない」に変わっていました。
                この変化が、自分の中ではかなり大きかったです。
              </p>
              <p className="mt-3">
                生活のために始めたはずなのに、頭の中は生活よりも、減ったお金をどう戻すかに寄っていきました。
              </p>
            </section>
            ...
            <section id="margin">
              ...
              <p className="mt-3">
                焦った私は、現物株と同じ感覚のまま、信用取引に切り替えました。
                投資対象を大きく変えたわけではありません。ただ、レバレッジをかければ取り返すスピードも上がるのではないか、と考えました。
              </p>
              <p className="mt-3">
                最大でおおよそ3.3倍程度だったと思います。
                当時の自分では、そこまで危険な方向へ進んでいる感覚は薄かったです。現物でやっていたことを、少し強くしただけ、くらいに思っていました。
              </p>
              <p className="mt-3">
                でも結果は逆でした。
                損失のスピードが早くなり、資金はさらに削られていきました。
              </p>
            </section>
            ...
            <section id="fx">
              ...
              <p className="mt-3">
                資金が尽きたあと、私はFXに移りました。
                レバレッジはおおよそ25倍。給料が入るたびに入金して、少し増えたと思ったら大きく負ける、という流れを繰り返していました。
              </p>
              <p className="mt-3">
                それでも勝ち切れず、今度は海外の業者も使いました。
                高いレバレッジが前面に出ているような取引です。今なら危うさが分かりますが、当時は「ここで取り返せるかもしれない」という期待の方が勝っていました。
              </p>
              <p className="mt-3">当然のように、そこでさらに負けました。</p>
            </section>

            <section id="loop">
              <h2 className="text-lg font-semibold text-stone-900 md:text-xl">振り返りなしのループ</h2>
              <p className="mt-3">
                今思うと、いちばん悪かったのは、負け方そのものよりも、振り返りをほとんどしていなかったことです。
              </p>
              <p className="mt-3">
                なぜ負けたのか。
                <br />
              ...
              <p className="mt-3">
                そういう整理をほぼしないまま、頭の中ではずっと同じ言葉が回っていました。
              </p>
              <p className="mt-3">
                「次はいける」
                <br />
              ...
              <p className="mt-3">
                そのたびに、自分の中に物語を作っていました。
                取り返すには勝つしかない。最後に勝てば全部戻せる。今は苦しいけれど、あと少し耐えれば大丈夫だと。
              </p>
              <p className="mt-3">
                口座の中には、自分なりの「戻すべき残高」がありました。
                そこに近づくと安心して、離れるとまた落ち着かなくなる。
                その落差を埋めるために、入金や借入を重ねていたのだと思います。
              </p>
            ...
            <section id="turning">
              ...
              <p className="mt-3">
                流れが止まったのは、投資で考え直せたからではありませんでした。
              </p>
              <p className="mt-3">
                ライフイベントで大きな出費が重なった時期に、クレジットカードのキャッシングの引き落としと、生活の支払いも重なりました。
                口座の中では「あと少しで戻せる」という感覚が残っていても、銀行口座の現実はまったく別のスケジュールで進んでいました。
              </p>
              <p className="mt-3">
                ここで初めて、口座と生活は別のカレンダーで動いているのだと痛感しました。
              </p>
              <p className="mt-3">
                取引口座の中でどれだけ取り返したいと思っていても、家賃や生活費や引き落とし日は待ってくれません。
                その現実に、ようやく追いつかれました。
              </p>
              <p className="mt-3">
                借りても足りない金額になり、私は妻と両親に助けを求めました。
                そのときに強く残ったのは、「ここまで来てしまった」という後悔と、自分のお金の問題を家族に背負わせてしまった重さでした。
              </p>
            </section>
            ...
            <section id="now">
              ...
              <p className="mt-3">
                今、取り返したいのは、妻や両親への信用です。
              </p>
              <p className="mt-3">
                お金は、時間をかければ少しずつ減らしていけるかもしれません。
                でも信用は、返済表のように一直線では戻らないと感じています。こちらもまた、別のカレンダーで進むものだと思っています。
              </p>
              <p className="mt-3">
                私は今、投資を止めています。
                それは、立派に決意できたからではありません。もう、それしか手段がなかったからです。
              </p>
              <p className="mt-3">
                勝負で埋める選択肢がなくなってから、ようやく「どう返すか」「どう暮らしを立て直すか」を考え始めました。
            ...
            <section id="lessons" className="space-y-6">
              ...
              <p>この体験を通して、自分の中に残った教訓は大きく3つあります。</p>
              ...
              <div>
                ...
                <p className="mt-2">
                  現物でうまくいかなかった判断が、そのまま信用やFXで急によくなるわけではありませんでした。
                  むしろ、焦りが強い状態でレバレッジをかけると、失敗の速度だけが上がりやすかったです。
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2">
                  ...
                  特に引き落としや生活費が重なる時期は、口座の中の希望より、銀行口座の現実の方が先に来ます。
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2">
                  自分ひとりの問題だと思っていたものが、家族に助けを求めた瞬間に、信用の問題にも変わりました。
                  だから今は、残高だけではなく、家族に対する向き合い方も含めて立て直しているつもりです。
                </p>
              </div>
            </section>
            ...
            <section id="tools">
              ...
              <p className="mt-3">
                感情が苦しい時期ほど、頭の中だけで考えると話が大きくなりやすいです。
                私がこのサイトで返済や固定費のツールを置いているのは、正解を出したいからではなく、まず見え方を整理したいからです。
              </p>
