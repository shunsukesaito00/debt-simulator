...
const SLUG = "borrow-200-15percent-5years-total-interest" as const;

const BASE = process.env.NEXT_PUBLIC_SITE_URL ?? "https://debt-simulator-quzc.vercel.app";
const ARTICLE_URL = `${BASE}/articles/${SLUG}`;
const ARTICLE_TITLE = "借金200万円・金利15%で5年返済すると総利息はいくら？元利均等の目安";

export const metadata: Metadata = {
  title: ARTICLE_TITLE,
  description:
    "借金200万円を年利15%で5年（60回）・元利均等返済した場合の総利息・月々返済額・総支払額の目安を、当サイトの計算ロジックに基づき整理します。3年・7年との比較も。",
  alternates: { canonical: ARTICLE_URL },
  openGraph: {
    title: ARTICLE_TITLE,
    description:
      "借金200万円を年利15%で5年返済した場合の総利息と月々の返済額の目安。元利均等・途中金利変更なしの試算例です。",
    url: ARTICLE_URL,
    type: "article",
  },
};
...
const jsonLd = {
  ...
  description:
    "借金200万円を年利15%で5年（60回）・元利均等返済した場合の総利息・月々返済額・総支払額の目安を整理します。",
  url: ARTICLE_URL,
...
const faqItems = [
  {
    question: "借金200万円・年利15%・5年返済の総利息の目安は？",
    answer:
      "元利均等返済・途中金利変更なし・利息端数切り捨ての試算では、総利息は約85.5万円（854,734円）、総支払額は約285.5万円が目安です。",
  },
  {
    question: "月々の返済額はいくらくらいですか？",
    answer:
      "初月の目安は約47,580円です。元利均等では毎月の返済額は原則一定ですが、最終月のみ端数調整で変わる場合があります。",
  },
  {
    question: "5年より短い期間にすると総利息はどう変わりますか？",
    answer:
      "同じ200万円・年利15%でも、3年（36回）にすると総利息は約49.6万円まで下がる目安です。月々の負担は増えますが、トータルの利息は抑えやすくなります。",
  },
  {
    question: "自分の条件で試すには？",
    answer:
      "借入返済シミュレーターで「元利均等」「借入額200万円」「返済期間5年」「年利15%」を設定すると、同様のイメージを確認できます。",
  },
];
...
const tocItems = [
  { id: "conclusion", label: "結論｜5年返済の総利息は約85.5万円が目安" },
  { id: "numbers", label: "5年（60回）返済の内訳" },
  { id: "compare", label: "3年・5年・7年にしたときの違い（200万円・15%）" },
        ...
        <div className="ds-card ds-card-pad">
          ...
          <ArticlePagePremise
            comparisonConditions={[
              "借入額200万円・年利15%（途中金利変更なし）",
              "返済方式は元利均等返済（回数指定）",
              "返済期間は5年＝60回払い",
            ]}
            reasonForConditions="「200万円・15%・5年・総利息」という具体的クエリに答えるため、借入額・金利・期間を固定して試算します。"
          />
          ...
          <ArticleProse className="mt-8 space-y-10">
            <p>
              借金200万円を年利15%で返していく場合、「5年で返すと総利息はいくらか」は返済計画のたたき台になります。ここでは
            ...
            <section id="conclusion">
              <h2 className="text-lg font-semibold text-stone-900 md:text-xl">結論｜5年返済の総利息は約85.5万円が目安</h2>
              <p className="mt-3">
                借入200万円・年利15%・元利均等・5年（60回）返済の試算では、
                <strong className="text-stone-900">総利息は約854,734円（約85.5万円）</strong>、
                <strong className="text-stone-900">総支払額は約2,854,734円（約285.5万円）</strong>
                が目安です。初月の返済額の目安は
                <strong className="text-stone-900">約47,580円</strong>
                です。
              </p>
            </section>
                ...
                <table className="w-full min-w-[280px] border-collapse text-left">
                  ...
                  <tbody className="text-stone-700">
                    <tr className="border-b border-stone-200">
                      ...
                      <td className="py-3">2,000,000円</td>
                    </tr>
                    <tr className="border-b border-stone-200">
                    ...
                    <tr className="border-b border-stone-200">
                      ...
                      <td className="py-3">約47,580円</td>
                    </tr>
                    <tr className="border-b border-stone-200">
                      <td className="py-3 pr-4">総利息</td>
                      <td className="py-3">約854,734円（約85.5万円）</td>
                    </tr>
                    <tr className="border-b border-stone-200">
                      <td className="py-3 pr-4">総支払額</td>
                      <td className="py-3">約2,854,734円</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <section id="compare">
              <h2 className="text-lg font-semibold text-stone-900 md:text-xl">3年・5年・7年にしたときの違い（200万円・15%）</h2>
              <p className="mt-3">
                ...
                <table className="w-full min-w-[360px] border-collapse text-left">
                  ...
                  <tbody className="text-stone-700">
                    <tr className="border-b border-stone-200">
                      ...
                      <td className="py-3 pr-4">約69,331円</td>
                      <td className="py-3">約495,874円（約49.6万円）</td>
                    </tr>
                    <tr className="border-b border-stone-200">
                    ...
                    <tr className="border-b border-stone-200">
                      ...
                      <td className="py-3 pr-4">約38,594円</td>
                      <td className="py-3">約1,241,748円（約124.2万円）</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <p className="mt-3">
                ...
                と並べると、借入額が増えるほど総利息の規模も大きくなるイメージがつかみやすいです。
              </p>
            </section>
            ...
            <section id="reading-points">
              <ArticleReadingPoints
                points={[
                  {
                    label: "5年返済の総利息は約85.5万円が目安",
                    body: "200万円・年利15%・元利均等・60回の試算です。",
                  },
                  {
                    label: "月々は約4.8万円前後（初月目安）",
                    body: "元利均等では毎月の返済額は概ね一定です。",
                  },
                  {
                    label: "期間を短くすると総利息は下がる",
                    body: "3年にすると総利息は約49.6万円まで下がる目安ですが、月々の返済は重くなります。",
                  },
                ]}
                misconceptions={[
                  "「200万円なら利息も小さい」と思いがちですが、15%・5年でも総利息は数十万円単位になります。",
                  "実際の商品は元利均等以外や金利変動がある場合があります。契約書を優先してください。",
                ]}
              />
            </section>
            ...
            <section id="simulator">
              ...
              <p className="mt-3">
                ...
                で「元利均等」「借入額200万円」「返済期間5年」「金利15%」を入力すると、返済表や総利息を確認できます。
              </p>
              <div className="mt-6">
            ...
            <section id="notice">
              ...
              <p className="mt-3">
                本記事の数値は、当サイトの計算ロジックに基づく参考値です。金融機関の約定日・日割り・手数料等は含めていません。
              </p>
            </section>

            <section id="editor-memo">
              <ArticleEditorMemo
                purpose="200万円・年利15%・5年・総利息というクエリに答える借入額別の専用記事です。"
                reasonAxis="300万円版（borrow-300-15percent-5years-total-interest）と対になる数値例として配置。"
                memo="数値は lib/loan-calc の元利均等・60回・年利15%で整合。"
              />
            </section>
            ...
            <section id="summary">
              ...
              <p className="mt-3">
                借金200万円を年利15%で5年・元利均等返済する場合の総利息は、試算上
                <strong className="text-stone-900">約85.5万円</strong>
                、総支払額は
                <strong className="text-stone-900">約285.5万円</strong>
                が目安です。
                <Link href="/articles/borrow-200-monthly-payment" className="font-bold text-stone-900 hover:underline">
                  200万円の月々返済を総合的に比較する記事
                </Link>
                や
                <Link href="/articles/borrow-300-15percent-5years-total-interest" className="font-bold text-stone-900 hover:underline">
                  300万円・5年の総利息
