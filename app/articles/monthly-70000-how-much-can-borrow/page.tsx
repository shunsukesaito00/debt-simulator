...
<div className="ds-card ds-card-pad">
          ...
          <ArticleStandardBlocks slug="monthly-70000-how-much-can-borrow" />
          ...
          <ArticleProse className="mt-8 space-y-10">
            ...
            <section id="summary">
              ...
              <p className="mt-3">
                月5万円の返済で考えたい方は
                <Link href="/articles/monthly-50000-how-much-can-borrow" className="font-bold text-stone-900 hover:underline">月5万円ならいくらまで借りられる？</Link>
