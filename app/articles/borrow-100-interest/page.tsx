      ...
      <article className="mx-auto max-w-3xl">
        ...
        <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-soft md:p-8">
          ...
          <div className="mt-8 space-y-10 text-sm text-gray-700 leading-relaxed">
            {/* 導入 */}
            <p>
              借金100万円をカードローンやフリーローンで借りた場合、実際にどれくらいの利息を支払うことになるのか気になる方は多いはずです。特に年利15%前後は消費者金融やカードローンでよく見かける水準なので、返済期間によって総支払額がどこまで増えるのかを把握しておくことは重要です。
            </p>
            <p>
              この記事では、借金100万円を年利15%で借りたケースを例に、月々の返済額、総支払額、総利息の目安をわかりやすく整理します。実際の条件で確認したい方は、
              <Link href="/simulator/cardloan" className="font-bold text-gray-900 hover:underline">借入返済シミュレーター</Link>
              で試算できます。
            </p>

            <section id="conclusion">
              <h2 className="text-lg font-black text-gray-900 md:text-xl">結論｜借金100万円を年利15%で借りると利息はどれくらいか</h2>
              <p className="mt-3">
                結論から言うと、借金100万円を年利15%で借りた場合、返済期間が3年なら総利息は約24.8万円、5年なら約42.7万円が目安です。返済期間が長くなるほど毎月の負担は軽くなりますが、その分だけ利息総額は大きくなります。
              </p>
              <p className="mt-3">
                つまり、月々の返済額を抑えることと、総支払額を抑えることは両立しません。毎月の資金繰りを優先するのか、支払総額を減らしたいのかで、適切な返済期間は変わります。
              </p>
            </section>

            <section id="how-interest">
              <h2 className="text-lg font-black text-gray-900 md:text-xl">そもそも利息はどう計算されるのか</h2>
              <p className="mt-3">
            ...
            <section id="3years">
              <h2 className="text-lg font-black text-gray-900 md:text-xl">借金100万円を3年で返す場合</h2>
              <p className="mt-3">
            ...
            <section id="5years">
              <h2 className="text-lg font-black text-gray-900 md:text-xl">借金100万円を5年で返す場合</h2>
              <p className="mt-3">
            ...
            <section id="balance">
              <h2 className="text-lg font-black text-gray-900 md:text-xl">どちらを選ぶべきか｜月々の負担と総支払額のバランス</h2>
              <p className="mt-3">
            ...
            <section id="reduce-interest">
              <h2 className="text-lg font-black text-gray-900 md:text-xl">利息を減らすための現実的な方法</h2>
            ...
            <section id="faq">
              ...
              <div className="mt-4 space-y-6">
                <div>
                  <h3 className="text-base font-black text-gray-900">借金100万円の利息は毎月いくらですか？</h3>
                  <p className="mt-2">
                    毎月の利息額は残高に応じて減っていくため一定ではありません。ただし、年利15%で借りる場合、借入初期は利息負担が比較的大きく、返済が進むにつれて徐々に減っていきます。
                  </p>
                </div>
                <div>
                  <h3 className="text-base font-black text-gray-900">借金100万円を返すには毎月いくら必要ですか？</h3>
                  <p className="mt-2">
                    年利15%で3年返済なら毎月約34,665円、5年返済なら約23,790円が目安です。実際には商品条件により変動します。
                  </p>
                </div>
