        ...
        <div className="ds-card ds-card-pad">
          ...
          <div className="mt-8 space-y-10 text-sm text-stone-700 leading-relaxed">
            ...
            <section id="conclusion">
              <h2 className="text-lg font-black text-stone-900 md:text-xl">結論｜借金200万円の月々返済はいくらか</h2>
              <p className="mt-3">
            ...
            <section id="reason">
              <h2 className="text-lg font-black text-stone-900 md:text-xl">借入200万円で返済額が重くなりやすい理由</h2>
              <p className="mt-3">
            ...
            <section id="3years">
              <h2 className="text-lg font-black text-stone-900 md:text-xl">借金200万円を3年で返す場合の月々返済額</h2>
              <p className="mt-3">
            ...
            <section id="5years">
              <h2 className="text-lg font-black text-stone-900 md:text-xl">借金200万円を5年で返す場合の月々返済額</h2>
              <p className="mt-3">
            ...
            <section id="balance">
              <h2 className="text-lg font-black text-stone-900 md:text-xl">どちらを選ぶべきか｜月々の返済額と総支払額のバランス</h2>
              <p className="mt-3">
            ...
            <section id="reduce-interest">
              <h2 className="text-lg font-black text-stone-900 md:text-xl">利息負担を減らすための現実的な方法</h2>
              <p className="mt-3">
            ...
            <section id="faq">
              ...
              <div className="mt-4 space-y-6">
                <div>
                  <h3 className="text-base font-black text-stone-900">借金200万円の月々返済額はどれくらいですか？</h3>
                  <p className="mt-2">
                    年利15%の目安では、3年返済なら約69,329円、5年返済なら約47,580円です。実際には商品条件により変動します。
                  </p>
                </div>
                <div>
                  <h3 className="text-base font-black text-stone-900">借金200万円の利息はどれくらいかかりますか？</h3>
                  <p className="mt-2">
                    年利15%で3年返済なら総利息は約49.6万円、5年返済なら約85.5万円が目安です。返済期間が長くなると利息は大きくなります。
                  </p>
                </div>
                <div>
                  <h3 className="text-base font-black text-stone-900">借金200万円を早く返す方法はありますか？</h3>
                  <p className="mt-2">
                    返済期間を短くする、追加返済を行う、金利条件を見直す、の3つが基本です。無理のない範囲で毎月の返済額を上げられると、総利息は下がりやすくなります。
                  </p>
                </div>
                <div>
                  <h3 className="text-base font-black text-stone-900">借金200万円と100万円では利息の負担はどれくらい違いますか？</h3>
                  <p className="mt-2">
                    年利15%・5年返済の場合、100万円なら総利息は約42.7万円ですが、200万円では約85.5万円と単純に2倍になります。借入額が増えると利息の絶対額も大きくなるため、返済期間の選択がより重要になります。
                  </p>
                </div>
                <div>
                  <h3 className="text-base font-black text-stone-900">月々5万円以下で200万円を返済することはできますか？</h3>
                  <p className="mt-2">
                    年利15%・5年返済なら月々約47,580円で返済できる計算です。ただし返済期間が長くなると総利息も増えるため、月々の負担と総支払額のバランスを確認して判断してください。
                  </p>
                </div>
