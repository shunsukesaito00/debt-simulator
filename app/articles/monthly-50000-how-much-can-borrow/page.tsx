...
<div className="ds-card ds-card-pad">
          ...
          <div className="mt-8 space-y-10 text-sm text-stone-700 leading-relaxed">
            ...
            <section id="conclusion">
              <h2 className="text-lg font-black text-stone-900 md:text-xl">結論｜月5万円返済なら借入額の目安は返済年数で大きく変わる</h2>
              <p className="mt-3">
            ...
            <section id="point">
              <h2 className="text-lg font-black text-stone-900 md:text-xl">「月5万円ならいくらまで借りられる？」を考えるときのポイント</h2>
              <p className="mt-3">
            ...
            <section id="compare">
              ...
              <div className="mt-8 ds-subcard p-4">
                <h3 className="text-base font-black text-stone-900">返済期間別の借入額目安</h3>
                <div className="mt-4">
                  <PrincipalBarChart />
                </div>
              </div>
            ...
            <section id="choose">
              <h2 className="text-lg font-black text-stone-900 md:text-xl">月5万円返済ならどの返済期間を選ぶべきか</h2>
              <p className="mt-3">
            ...
            <section id="faq">
              ...
              <div className="mt-4 space-y-6">
                <div>
                  <h3 className="text-base font-black text-stone-900">月5万円返済なら何万円くらいまで借りられますか？</h3>
                  <p className="mt-2">
                    年利15%の近似例では、3年返済で約144万円、5年返済で約210万円、7年返済で約255万円が目安です。実際の条件によって変わります。
                  </p>
                </div>
                <div>
                  <h3 className="text-base font-black text-stone-900">月5万円返済なら200万円借りても大丈夫ですか？</h3>
                  <p className="mt-2">
                    年利15%の近似例では、5年返済前後を前提にすると200万円台前半が一つの目安になります。ただし、生活費や他の支出も踏まえて無理のない返済計画かを確認する必要があります。
                  </p>
                </div>
                <div>
                  <h3 className="text-base font-black text-stone-900">月5万円返済で借入額を増やす方法はありますか？</h3>
                  <p className="mt-2">
                    返済期間を延ばせば借入額の目安は増えますが、そのぶん総利息も増えます。借入額だけでなく総支払額とのバランスを見ることが重要です。
                  </p>
                </div>
                <div>
                  <h3 className="text-base font-black text-stone-900">月5万円返済で安全に借りられる目安はどのくらいですか？</h3>
                  <p className="mt-2">
                    一概には言えませんが、生活費や他の固定費を差し引いたうえで無理なく返せる範囲が前提です。年利15%の場合、3年返済の約144万円は比較的総利息を抑えやすい目安になります。
                  </p>
                </div>
