...
const monthsData = [
  { label: "毎月3万円", months: 50 },
  { label: "毎月5万円", months: 24 },
  { label: "毎月7万円", months: 16 },
];

const interestData = [
  { label: "毎月3万円", value: 475166 },
  { label: "毎月5万円", value: 185022 },
  { label: "毎月7万円", value: 111009 },
];

const stackData = [
  { label: "毎月3万円", 元本: 1000000, 利息: 475166 },
  { label: "毎月5万円", 元本: 1000000, 利息: 185022 },
  { label: "毎月7万円", 元本: 1000000, 利息: 111009 },
];
    ...
    <div className="h-[260px] w-full min-w-0">
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={monthsData} margin={{ top: 8, right: 8, left: 8, bottom: 8 }} barCategoryGap="12%">
          ...
          <Tooltip
            formatter={(v) => (v != null ? [`${Number(v)}か月`, "完済までの目安"] : "")}
            contentStyle={{ fontSize: 12 }}
            labelFormatter={(l) => l}
          />
          <Bar dataKey="months" fill={STONE_800} radius={[4, 4, 0, 0]} name="完済までの目安（か月）" />
        </BarChart>
      </ResponsiveContainer>
    </div>
  );
