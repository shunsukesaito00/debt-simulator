...
const SLUG = "borrow-500-15percent-5years-total-interest" as const;

const BASE = process.env.NEXT_PUBLIC_SITE_URL ?? "https://debt-simulator-quzc.vercel.app";
const ARTICLE_URL = `${BASE}/articles/${SLUG}`;
const ARTICLE_TITLE = "借金500万円・金利15%で5年返済すると総利息はいくら？元利均等の目安";

export const metadata: Metadata = {
  title: ARTICLE_TITLE,
  description:
    "借金500万円を年利15%で5年（60回）・元利均等返済した場合の総利息・月々返済額・総支払額の目安を、当サイトの計算ロジックに基づき整理します。3年・7年との比較も。",
  alternates: { canonical: ARTICLE_URL },
  openGraph: {
    title: ARTICLE_TITLE,
    description:
      "借金500万円を年利15%で5年返済した場合の総利息と月々の返済額の目安。元利均等・途中金利変更なしの試算例です。",
    url: ARTICLE_URL,
    type: "article",
  },
};
...
const jsonLd = {
  ...
  description:
    "借金500万円を年利15%で5年（60回）・元利均等返済した場合の総利息・月々返済額・総支払額の目安を整理します。",
  url: ARTICLE_URL,
...
const faqItems = [
  {
    question: "借金500万円・年利15%・5年返済の総利息の目安は？",
    answer:
      "元利均等返済・途中金利変更なし・利息端数切り捨ての試算では、総利息は約213.7万円（2,136,923円）、総支払額は約713.7万円が目安です。",
  },
  {
    question: "月々の返済額はいくらくらいですか？",
    answer:
      "初月の目安は約118,950円です。元利均等では毎月の返済額は原則一定ですが、最終月のみ端数調整で変わる場合があります。",
  },
  {
    question: "5年より短い期間にすると総利息はどう変わりますか？",
    answer:
      "同じ500万円・年利15%でも、3年（36回）にすると総利息は約124.0万円まで下がる目安です。月々の負担は増えますが、トータルの利息は抑えやすくなります。",
  },
  {
    question: "自分の条件で試すには？",
    answer:
      "借入返済シミュレーターで「元利均等」「借入額500万円」「返済期間5年」「年利15%」を設定すると、同様のイメージを確認できます。",
  },
];
...
const tocItems = [
  { id: "conclusion", label: "結論｜5年返済の総利息は約213.7万円が目安" },
  { id: "numbers", label: "5年（60回）返済の内訳" },
  { id: "compare", label: "3年・5年・7年にしたときの違い（500万円・15%）" },
        ...
        <div className="ds-card ds-card-pad">
          ...
          <ArticlePagePremise
            comparisonConditions={[
              "借入額500万円・年利15%（途中金利変更なし）",
              "返済方式は元利均等返済（回数指定）",
              "返済期間は5年＝60回払い",
            ]}
            reasonForConditions="「500万円・15%・5年」という検索クエリに答えるため、借入額・金利・期間を固定して総利息と月々の目安を示します。"
          />
          ...
          <ArticleProse className="mt-8 space-y-10">
            <p>
              借金500万円を年利15%で返していく場合、「5年で返すと総利息はいくらになるのか」は、返済計画を立てるうえで押さえておきたいポイントです。ここでは
            ...
            <section id="conclusion">
              <h2 className="text-lg font-semibold text-stone-900 md:text-xl">結論｜5年返済の総利息は約213.7万円が目安</h2>
              <p className="mt-3">
                借入500万円・年利15%・元利均等・5年（60回）返済の試算では、
                <strong className="text-stone-900">総利息は約2,136,923円（約213.7万円）</strong>、
                <strong className="text-stone-900">総支払額は約7,136,923円（約713.7万円）</strong>
                が目安です。初月の返済額の目安は
                <strong className="text-stone-900">約118,950円</strong>
                です。
              </p>
            </section>
                ...
                <table className="w-full min-w-[280px] border-collapse text-left">
                  ...
                  <tbody className="text-stone-700">
                    <tr className="border-b border-stone-200">
                      ...
                      <td className="py-3">5,000,000円</td>
                    </tr>
                    <tr className="border-b border-stone-200">
                    ...
                    <tr className="border-b border-stone-200">
                      ...
                      <td className="py-3">約118,950円</td>
                    </tr>
                    <tr className="border-b border-stone-200">
                      <td className="py-3 pr-4">総利息</td>
                      <td className="py-3">約2,136,923円（約213.7万円）</td>
                    </tr>
                    <tr className="border-b border-stone-200">
                      <td className="py-3 pr-4">総支払額</td>
                      <td className="py-3">約7,136,923円</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <section id="compare">
              <h2 className="text-lg font-semibold text-stone-900 md:text-xl">3年・5年・7年にしたときの違い（500万円・15%）</h2>
              <p className="mt-3">
                ...
                <table className="w-full min-w-[360px] border-collapse text-left">
                  ...
                  <tbody className="text-stone-700">
                    <tr className="border-b border-stone-200">
                      ...
                      <td className="py-3 pr-4">約173,327円</td>
                      <td className="py-3">約1,239,730円（約124.0万円）</td>
                    </tr>
                    <tr className="border-b border-stone-200">
                    ...
                    <tr className="border-b border-stone-200">
                      ...
                      <td className="py-3 pr-4">約96,484円</td>
                      <td className="py-3">約3,104,546円（約310.5万円）</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <p className="mt-3">
                借入額が大きいほど、期間を延ばしたときの総利息の伸びも大きくなりやすいです。5年は月々の負担と総利息のバランスを取りたい場合に選ばれやすい期間のひとつです。期間の延長で総利息がどう伸びるかは、
            ...
            <section id="reading-points">
              <ArticleReadingPoints
                points={[
                  {
                    label: "5年返済の総利息は約213.7万円が目安",
                    body: "500万円・年利15%・元利均等・60回の試算です。契約の端数処理と完全一致するとは限りません。",
                  },
                  {
                    label: "月々は約11.9万円前後（初月目安）",
                    body: "元利均等では毎月の返済額は概ね一定です。完済までのキャッシュフローをイメージしやすいです。",
                  },
                  {
                    label: "期間を短くすると総利息は下がる",
                    body: "3年にすると総利息は約124.0万円まで下がる目安ですが、月々の返済は重くなります。",
                  },
                ]}
                misconceptions={[
                  "「5年なら利息は軽い」と決めつけないこと。借入額が500万円と大きいと、総利息は200万円を超える目安になります。",
            ...
            <section id="simulator">
              ...
              <p className="mt-3">
                ...
                で「借入額500万円」「返済方式：元利均等」「返済期間5年」「金利15%」を入力すると、返済表や総利息を自分の前提で確認できます。A/Bで期間だけ変えて比較するのもおすすめです。
              </p>
              <div className="mt-6">
            ...
            <section id="summary">
              ...
              <p className="mt-3">
                借金500万円を年利15%で5年・元利均等返済する場合の総利息は、試算上
                <strong className="text-stone-900">約213.7万円</strong>
                、総支払額は
                <strong className="text-stone-900">約713.7万円</strong>
