...
<div className="ds-card ds-card-pad">
          ...
          <div className="mt-8 space-y-10 text-sm text-stone-700 leading-relaxed">
            ...
            <section id="conclusion">
              <h2 className="text-lg font-black text-stone-900 md:text-xl">結論｜定額元利で完済できないのは返済額が利息に負けるから</h2>
              <p className="mt-3">
            ...
            <section id="what-is">
              <h2 className="text-lg font-black text-stone-900 md:text-xl">定額元利とは何か</h2>
              <p className="mt-3">
            ...
            <section id="cannot-payoff">
              <h2 className="text-lg font-black text-stone-900 md:text-xl">完済できない状態とはどういうことか</h2>
              <p className="mt-3">
            ...
            <section id="why-danger">
              <h2 className="text-lg font-black text-stone-900 md:text-xl">なぜ返済額が低いと危険なのか</h2>
              <p className="mt-3">
            ...
            <section id="case-a">
              <h2 className="text-lg font-black text-stone-900 md:text-xl">ケースA｜毎月1万円では完済できないに近い</h2>
              <p className="mt-3">
            ...
            <section id="case-b">
              <h2 className="text-lg font-black text-stone-900 md:text-xl">ケースB｜毎月1万5千円なら完済はするが非常に遅い</h2>
              <p className="mt-3">
            ...
            <section id="case-c">
              <h2 className="text-lg font-black text-stone-900 md:text-xl">ケースC｜毎月3万円なら現実的に完済しやすい</h2>
              <p className="mt-3">
            ...
            <section id="compare">
              <h2 className="text-lg font-black text-stone-900 md:text-xl">3つのケースを比較すると何が違うか</h2>
                ...
                <table className="w-full min-w-[480px] border-collapse text-left">
                  <thead>
                    <tr className="border-b-2 border-stone-200">
                      ...
                      <th className="py-3 pr-4 font-black text-stone-900">初月利息</th>
                      <th className="py-3 pr-4 font-black text-stone-900">初月元本充当</th>
                      <th className="py-3 pr-4 font-black text-stone-900">完済目安</th>
                      <th className="py-3 pr-4 font-black text-stone-900">総利息</th>
                      <th className="py-3 font-black text-stone-900">評価</th>
                    </tr>
                  </thead>
              ...
              <div className="mt-8 ds-subcard p-4">
                <h3 className="text-base font-black text-stone-900">毎月1万円のケース（注意）</h3>
                <div className="mt-4">
                  <CannotPayoffWarningCard />
                </div>
              </div>
              ...
              <div className="mt-8 ds-subcard p-4">
                <h3 className="text-base font-black text-stone-900">完済目安の比較（毎月1万5千円 vs 毎月3万円）</h3>
                <div className="mt-4">
                  <PayoffMonthsBarChart />
                </div>
              </div>
            ...
            <section id="suit">
              <h2 className="text-lg font-black text-stone-900 md:text-xl">定額元利が向いているケース・向いていないケース</h2>
              <p className="mt-3">
            ...
            <section id="avoid">
              <h2 className="text-lg font-black text-stone-900 md:text-xl">完済できない状態を避けるにはどうすればいいか</h2>
              <p className="mt-3">
            ...
            <section id="faq">
              ...
              <div className="mt-4 space-y-6">
                <div>
                  <h3 className="text-base font-black text-stone-900">定額元利で完済できないことは本当にありますか？</h3>
                  <p className="mt-2">
                    毎月返済額が利息以下だと、少なくとも一般的な考え方では元本が減らず、完済できない条件に近くなります。返済額設定が重要です。
                  </p>
                </div>
                <div>
                  <h3 className="text-base font-black text-stone-900">利息より返済額が少ないとどうなりますか？</h3>
                  <p className="mt-2">
                    その月の返済が利息に吸収され、元本が減りません。条件次第では、返済しているつもりでも借金がほとんど減らない状態になります。
                  </p>
                </div>
                <div>
                  <h3 className="text-base font-black text-stone-900">定額元利でも完済しやすくする方法はありますか？</h3>
                  <p className="mt-2">
                    毎月返済額を引き上げる、追加返済を行う、金利条件を見直す、といった方法が有効です。特に返済額が低すぎる場合は見直しが重要です。
                  </p>
                </div>
                <div>
                  <h3 className="text-base font-black text-stone-900">完済できない状態に近づいている兆候はありますか？</h3>
                  <p className="mt-2">
                    毎月返済しているのに残高がほとんど減らない、または明細の元本充当額が極端に小さい場合は注意が必要です。返済額の大部分が利息に消えている可能性があるため、明細で元本と利息の内訳を確認してみてください。
                  </p>
                </div>
                <div>
                  <h3 className="text-base font-black text-stone-900">返済が追いつかないと感じたらどうすればいいですか？</h3>
                  <p className="mt-2">
                    まずは現状の返済額が利息を上回っているかを確認し、可能であれば返済額の引き上げや追加返済を検討してください。それでも難しい場合は、金融機関への相談や、公的な相談窓口（消費生活センターなど）への早めの相談が重要です。
                  </p>
                </div>
