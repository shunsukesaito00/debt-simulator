  ...
  return (
    <div className="ds-card ds-card-pad">
      ...
      <div className="mt-5 grid gap-5 text-sm text-stone-700 leading-relaxed">
        <section>
          <h2 className="text-base font-black text-stone-900">取得する情報</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-base font-black text-stone-900">広告について（第三者配信）</h2>
          <p className="mt-2">
          ...
          <p className="mt-2">
            ...
            また、Google の広告設定（<code className="rounded bg-stone-100 px-1">https://adssettings.google.com/</code>）で、
            パーソナライズ広告を無効にすることもできます。
          </p>
        </section>

        <section>
          <h2 className="text-base font-black text-stone-900">アクセス解析について</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-base font-black text-stone-900">お問い合わせで取得する個人情報</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-base font-black text-stone-900">Cookie の管理</h2>
          <p className="mt-2">
