...
export default function Page() {
  return (
    <div className="ds-card ds-card-pad">
      ...
      <p className="mt-2 rounded-xl border border-stone-200 bg-stone-50 px-4 py-2 text-sm text-stone-600">
        すべての計算はお使いのブラウザ内だけで行われます。入力したデータが外部に送信されることはありません。
      </p>

      <div className="mt-5 grid gap-5 text-sm text-stone-700 leading-relaxed">
        <section>
          <h2 className="text-base font-black text-stone-900">1. 借入条件を入力</h2>
        ...
        <section>
          <h2 className="text-base font-black text-stone-900">2. ボーナス返済（任意）</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-base font-black text-stone-900">3. 結果の見方</h2>
          <ul className="mt-2 list-disc pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-base font-black text-stone-900">4. CSV出力</h2>
          <p className="mt-2">
