  ...
  return (
    <div className="ds-card ds-card-pad">
      ...
      <div className="mt-5 grid gap-5 text-sm text-stone-700 leading-relaxed">
        <section>
          <h2 className="text-base font-black text-stone-900">前提</h2>
        ...
        <section>
          <h2 className="text-base font-black text-stone-900">端数処理</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-base font-black text-stone-900">最終月の調整</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-base font-black text-stone-900">返済方式</h2>
          <div className="mt-2 grid gap-3">
            <div>
              <div className="font-black text-stone-900">元利均等（回数指定）</div>
              <div>
            ...
            <div>
              <div className="font-black text-stone-900">元金均等（回数指定）</div>
              <div>
                元金を毎月一定で返済し、利息は残高に応じて逓減します。返済初期の支払が大きくなりやすい特徴があります。
              </div>
            </div>
            <div>
              <div className="font-black text-stone-900">定額元利（金額指定）</div>
              <div>
                毎月返済額を固定し、利息を差し引いた残りが元金になります。返済額が利息以下の場合、完済不能となるためエラー表示します。
              </div>
            </div>
            <div>
              <div className="font-black text-stone-900">定額元金（金額指定）</div>
              <div>
        ...
        <section>
          <h2 className="text-base font-black text-stone-900">免責</h2>
          <p className="mt-2">
