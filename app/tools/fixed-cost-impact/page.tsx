    ...
    <div className="ds-page-width">
      <nav className="mb-4 text-sm text-stone-600" aria-label="パンくず">
        <ol className="flex flex-wrap items-center gap-1">
          ...
          <li>
            <Link href="/articles" className="font-medium text-stone-800 hover:underline">
          ...
          <div className="mt-4 space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-1.5 w-full max-w-[12rem] rounded-xl border-2 border-stone-200 px-4 py-2.5 text-base font-bold text-stone-900 outline-none focus:border-stone-800"
              />
            </div>
            <div>
              <label htmlFor="months" className="block text-sm font-bold text-stone-800">
              ...
              <input
                ...
                className="mt-1.5 w-full max-w-[10rem] rounded-xl border-2 border-stone-200 px-4 py-2.5 text-base font-bold text-stone-900 outline-none focus:border-stone-800"
              />
              <p className="mt-1 text-xs text-stone-500">未入力の場合は1年・3年・5年のみ表示します。</p>
            </div>
          </div>
        </section>
            ...
            <table className="w-full min-w-[280px] text-sm">
              ...
              <tbody>
                <tr className="border-b border-stone-100">
                  ...
                  <td className="py-2.5 text-right font-bold text-stone-900">{formatYen(results.oneYear)}</td>
                </tr>
                <tr className="border-b border-stone-100">
                  <td className="py-2.5 pr-4">3年（36か月）</td>
                  <td className="py-2.5 text-right font-bold text-stone-900">{formatYen(results.threeYears)}</td>
                </tr>
                <tr className="border-b border-stone-100">
                  <td className="py-2.5 pr-4">5年（60か月）</td>
                  <td className="py-2.5 text-right font-bold text-stone-900">{formatYen(results.fiveYears)}</td>
                </tr>
                {results.custom != null && results.months != null && results.months > 0 && (
                  <tr className="border-b border-stone-100 bg-stone-50/50">
                    <td className="py-2.5 pr-4">{results.months}か月</td>
                    <td className="py-2.5 text-right font-bold text-stone-900">{formatYen(results.custom)}</td>
                  </tr>
                )}
              </tbody>
            </table>
